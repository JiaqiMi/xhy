# The YOLOv8Detector class initializes a YOLO model based on a specified detection mode, processes
# image messages using the model, and publishes the detected object centers or corners with confidence
# values.
